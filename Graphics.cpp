...
//--------------------------------------------------------
// Helper for creating a cubemap texture from six given textures of the same dimensions
// From A7 - D3D12 Cubemap Loading Code
// 
// right, left, up, down, front, back - Filepaths to each texture to use for the sides of the cubemap
//--------------------------------------------------------
